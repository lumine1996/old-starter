package com.cgm.temporary.util;
...
public class RandomContentUtils {
     ...
     * @return 日期数组
     */
    public static String[] fakeDates(Integer days) {
        return fakeDates(days, 1, Calendar.DATE);
    }
     ...
     * @return 日期数组
     */
    public static String[] fakeDates(Integer days, Integer interval, int field) {
        String[] dates = new String[days];
        for (int i = 0; i < days; i++) {
            dates[i] = fakeDate((i - days) * interval, field);
        }
        return dates;
    }
